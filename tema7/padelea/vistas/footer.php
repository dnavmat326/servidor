                ...
                <div class="modal-body">
                    <form id='formInsertar'>
                        ...
                        <div class='mb-3'>
                            ...
                            <input type="text" class='form-input' name="hora" required>
                        </div>
                        <div class='mb-3'>
                            <label for='ciudad' class='form-label'>Ciudad</label>
                            <input type="text" class='form-input' name="ciudad" required>
                        </div>
                        <div class='mb-3'>
                            <label for='lugar' class='form-label'>Lugar</label>
                            <input type="text" class='form-input' name="lugar" required>
                        </div>

                        <div class='mb-3'>
                            <label for='cubierto' class='form-label'>Pista Cubierta</label> <br>
                            <select class="form-select" name='cubierto' aria-label="Default select example">
                                <option name='cubierto' value="1">Si</option>
                                <option name='cubierto' value="0">No</option>
                            </select>
